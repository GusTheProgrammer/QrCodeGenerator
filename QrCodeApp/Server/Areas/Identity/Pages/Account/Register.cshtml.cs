...
namespace QrCodeApp.Server.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private ApplicationUser CreateUser(string apiKey)
        {
            try
            {
                var user = Activator.CreateInstance<ApplicationUser>();
                user.ApiKey = apiKey; // Set the ApiKey
                return user;
            }
            catch
            {
                ...
                Headers =
        {
            ...
            using (var response = await client.SendAsync(request))
            {
                ...
                // Parse the JSON response to extract the ApiKey
